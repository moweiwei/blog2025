<template>
  <div
    ...
    class="group relative mt-8 overflow-hidden rounded-2xl border transition-all duration-300 cursor-pointer break-inside-avoid-column hover:-translate-y-1 vp-themed-card"
  >
    <span
    ...
    <div class="relative z-10 flex flex-col gap-3 px-5 py-4 sm:px-6">
      <div
        class="flex items-center justify-between gap-4 text-xs font-semibold tracking-[0.2em] uppercase vp-text-muted"
      >
      ...
      <div
        class="flex flex-col gap-3 pt-4 border-t sm:flex-row sm:items-center sm:justify-between vp-themed-border"
      >
